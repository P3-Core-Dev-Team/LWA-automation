...
var applicationcreation_1 = require("../LIB/applicationcreation");
var protractor_1 = require("protractor");
var excel_1 = require("../POM/excel");
describe('TS_002 application creation ', function () {
    var sleep = 3000;
    var x = new excel_1.rexcel();
    var Signin = new Login_1.LoginLocators();
    var Appcreate = new applicationcreation_1.appcreation();
    protractor_1.browser.ignoreSynchronization = true;
    beforeEach(function () {
        jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    });
    it('TC_001: Open LWA URL LAUNCH', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('TC_002:Create application ', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
